...
var mongodbUrl = "mongodb+srv://Hemanta:Hemanta12345@@cluster0.mwwvx.mongodb.net/Ecommerce?retryWrites=true&w=majority";

function deleteProductForAdmin(req, res) {
        ...
        if (err) {
            ...
            db.collection("AllProducts", (err, coll) => {
                if (err) {
                    ...
                    coll.deleteOne({ pid: datacoming.pid }, (err, res1) => {
                        if (err) {
                            res.status(500);
...
module.exports = { deleteProductForAdmin };